package com.shuai.wechat.common.enums;
...
public enum HttpStatusEnum {
    ...
    public static String getMsgByCode(int code) {
        HttpStatusEnum[] httpStatusEnums = values();
        for (HttpStatusEnum statusEnum:httpStatusEnums) {
    ...
    public String getMsgUS() {
        return msgUS;
    }

    public void setMsgUS(String msgUS) {
        this.msgUS = msgUS;
    }
