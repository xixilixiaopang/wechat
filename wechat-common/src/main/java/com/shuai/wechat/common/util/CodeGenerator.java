...
/**
 * @author mi
 * @description: mybatis plus 提供的代码生成器可以快速生成
 * Entity、
 * Mapper、
 * Mapper XML、
 * Service、
...
public class CodeGenerator {
     ...
     * 数据库 URL
     */
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/wechat?serverTimezone=GMT%2B8";
    /**
     * 数据库驱动
     */
     ...
     * @author 值
     */
    private static final String AUTHOR = "zheng";
    /**
     * 包的基础路径
     */
    private static final String BASE_PACKAGE_URL = "com.shuai.wechat.common";
    /**
     * xml文件路径
     */
    private static final String XML_PACKAGE_URL = "xml";
    /**
     * xml 文件模板
     */
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(projectPath + "/wechat-common/src/main/java");
